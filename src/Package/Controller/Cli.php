...
namespace Package\Raxon\Org\Boot\Controller;
...
class Cli extends Controller {
    ...
    const INFO = [
        '{{binary()}} raxon_org/boot                    | boot options',
        '{{binary()}} raxon_org/boot setup              | boot setup',
        '{{binary()}} raxon_org/boot update             | boot update',
    ];
